...
public class Zadatak2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        actions.moveToElement(driver.findElement(By.id("menu-item-6408"))).build().perform();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='menu-item-6408']/ul")));
        Thread.sleep(2000);
        actions.moveToElement(driver.findElement(By.id("menu-item-5362"))).build().perform();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='menu-item-5453']/ul")));
        Thread.sleep(2000);
        actions.moveToElement(driver.findElement(By.id("menu-item-5453"))).build().perform();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='menu-item-5453']/ul")));
        Thread.sleep(5000);
        driver.quit();
    }
